...
#### Methods/Functions
- [ ] `(l LegacyKeyEncoding) CtrlAt` (line 109)
- [ ] `(l LegacyKeyEncoding) CtrlI` (line 120)
- [ ] `(l LegacyKeyEncoding) CtrlM` (line 131)
...
- [ ] `(p *EventDecoder) parseCsi` (line 301)
- [ ] `(p *EventDecoder) parseSs3` (line 699)
- [ ] `(p *EventDecoder) parseOsc` (line 763)
- [ ] `(p *EventDecoder) parseStTerminated` (line 863)
- [ ] `(p *EventDecoder) parseDcs` (line 941)
- [ ] `(p *EventDecoder) parseApc` (line 1058)
- [ ] `(p *EventDecoder) parseUtf8` (line 1085)
- [ ] `(p *EventDecoder) parseControl` (line 1126)
