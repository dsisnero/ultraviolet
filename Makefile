.PHONY: build install spec spec-all spec-provider spec-provider-record spec-interactive clean format docs build-examples check-go-test-parity check-go-source-parity
